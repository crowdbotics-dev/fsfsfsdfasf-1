"""
Django settings for fsfsfsdfasf_1 project.
...
ROOT_URLCONF = 'fsfsfsdfasf_1.urls'
...
WSGI_APPLICATION = 'fsfsfsdfasf_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "fsfsfsdfasf Support <support@fsfsfsdfasf-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fsfsfsdfasf_1 API",
    "DESCRIPTION": "API documentation for fsfsfsdfasf_1 App",
    "VERSION": "v1",
}
